...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-20 shadow-xl z-[100] p-5 bg-[#ecf0f3]">
      ...
      <div className={nav ? 'md:hidden fixed left-0 top-0 w-full h-screen bg-black/70' : ''}>
        <div className={nav ? ' fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] bg-opacity-100 p-10 ease-in duration-1000': 
                                'fixed top-0 left-[-100%]  ease-in duration-1000 h-screen bg-opacity-100'}>
